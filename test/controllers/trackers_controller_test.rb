...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post trackers_url, params: { tracker: { assignment: @tracker.assignment, center: @tracker.center, course: @tracker.course, due_date: @tracker.due_date, start_date: @tracker.start_date, weight: @tracker.weight } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { assignment: @tracker.assignment, center: @tracker.center, course: @tracker.course, due_date: @tracker.due_date, start_date: @tracker.start_date, weight: @tracker.weight } }
